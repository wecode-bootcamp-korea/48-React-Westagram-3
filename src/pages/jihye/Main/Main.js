...
{/* nav */}
      <nav>
        <ul id='navLeft'>
          <li><img src='images/jihye/logo.png' alt='logo'></img></li>
          <li> | </li>
          <li>Westagram</li>
        </ul>
        ...
        <div id='navRight'>
          <ul className='naviRightImage'>
            <li><img src='images/jihye/compass.png' alt='compass'></img></li>
            <li><img src='images/jihye/heart.png' alt='heart'></img></li>
            <li><img src='images/jihye/user.png' alt='user'></img></li>
        </ul>
        </div>
      </nav>
...
{/* div #main */}
      ...
      {/* #userSection */}
            <div id= 'userSection'>
              ...
              <img className="more" src= 'images/jihye/more.png' alt= '설정'></img>
            </div>
      {/* #userImage */}
            <div id= 'userImage'>
      ...
      {/* #guestSection */}
            <div id= 'guestSection'>
              ...
              <div className= 'likeCount'>
                <img class = 'friendprofile' src= 'images/jihye/lee.jpg' alt= '프로필'></img><span className='bold'>friend_00_ID</span>님 <span className='bold'>외 4명</span>이 좋아합니다
              </div>

              <div className='comment'>
                <img src='images/jihye/heart.png' alt='heart'></img>
                <img src='images/jihye/heart.png' alt='heart'></img>
                <p><span className="bold">friend_00_ID</span> 강아지 너무 귀엽다! 어디서 찍은 사진... <span className="gray">더보기</span></p>
                <p><span className="bold">friend_01_ID</span> 누구네 강아지야???🐶</p>
                <p className="bold gray">42분 전</p>
              </div>

              <div className='commentPush'>
                <input className= "bold" type='text' placeholder="댓글 달기..."></input>
                <button className="bold">게시</button>
              </div>
            </div>
  ...
  {/* .right */}
        <div className='right'>
          <table id= 'myprofile'>
            <td><img src= 'images/jihye/lee.jpg' alt= '프로필'></img></td>
            <td>
              <tr>jihyelo</tr>
          ...
          <table id= 'commend'>
            <th colspan='2' className="gray">회원님을 위한 추천</th>
            <th>모두 보기</th>
              <tr>
                <td>
                <img src= 'images/jihye/lee.jpg' alt= '프로필'></img>
